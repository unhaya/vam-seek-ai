 ...
 * v2.0 adds Thaw Decoder (VAM-RGB Image → Video reconstruction).
 */
...
const GridProcessorPlugin = (function() {
  ...
  const prompts = {
    ...
    'vam-rgb-thaw': window.VAMRGBThaw
  };
  ...
  /**
   * Get the Thaw Decoder prompt for temporal reconstruction
   * @returns {Object} VAMRGBThaw instance
   */
  function getThawDecoder() {
    return window.VAMRGBThaw;
  }
