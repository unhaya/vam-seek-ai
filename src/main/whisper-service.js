...
// v7.44: Added noise cancellation filter to reduce hallucinations
async function extractAudio(videoPath, startSec, endSec) {
  ...
  const audioFilter = 'highpass=f=200,lowpass=f=3000,silenceremove=stop_periods=-1:stop_duration=1:stop_threshold=-30dB';
  ...
  return new Promise((resolve, reject) => {
    const args = [
      ...
      '-i', videoPath,
      '-t', duration.toString(),
      '-af', audioFilter,     // v7.44: Noise cancellation
