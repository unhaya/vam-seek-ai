...
This specification and all described methods are licensed under **CC BY-NC 4.0 International**. Copyright (c) 2026 Susumu Takahashi (unhaya). All rights reserved.
...
The 150:1 frame reduction demonstrated by VAM-RGB eliminates the computational advantage of resource-rich corporations. By publishing this technology as prior art under CC BY-NC 4.0:
