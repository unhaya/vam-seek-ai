...
テスト中にZero Modeの挙動が想定を超えたため、安全性を確認できるまで公開を見送る判断をしました。隠蔽ではなく、検証が必要という判断です。
...
- [VAM-RGB Defensive Publication (Zenodo)](https://zenodo.org/records/18366858) - Technical specification and prior art documentation
